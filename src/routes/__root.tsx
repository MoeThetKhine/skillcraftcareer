...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SkillCraft is an AI-powered job portal that matches your skills to real opportunities." },
      { name: "author", content: "SkillCraft" },
      { property: "og:title", content: "SkillCraft — Build Skills. Find Opportunities." },
      { property: "og:description", content: "AI-powered skill matching between candidates and jobs." },
      ...
      <AuthProvider>
        <div className="flex min-h-screen flex-col">
          ...
          <footer className="border-t border-border py-8 text-center text-sm text-muted-foreground">
            SkillCraft — Build Skills. Find Opportunities.
          </footer>
        </div>
